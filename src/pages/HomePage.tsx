      ...
      <div className={styles['home-page']}>
        <section className={styles['man_or_woman']}>
          ...
          >
            ...
            />
            <div
              className={`${styles['man_or_woman--woman-border']} ${
                isMan === false ? styles['woman-border-color'] : null
              } `}
            />
          </div>
          <div
          ...
          >
            ...
            />
            <div
              className={`${styles['man_or_woman--man-border']} ${
                isMan === true ? styles['man-border-color'] : null
              } `}
            />
          </div>
        </section>
        <div className={styles['code_options']}>
          <button
            ...
            className={`button unselected ${
              foodOption === 'exchange' ? 'selected' : null
            }`}
          >
            تبادل
          </button>
          <button
            ...
            className={`button unselected ${
              foodOption === 'requested' ? 'selected' : null
            }`}
          >
            درخواستی
          </button>
          <button
            ...
            className={`button unselected ${
              foodOption === 'transfer' ? 'selected' : null
            }`}
          >
            واگذاری
          </button>
